  ...
  return (
    <section className="py-20">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Header — matches About/Services style */}
        <motion.div
          ...
          {faqData.map((item, index) => (
            ...
            >
              <button
                ...
                className="w-full flex justify-between items-start gap-6 py-6 text-left bg-transparent border-none cursor-pointer group"
              >
                <span className="text-sm md:text-base font-medium text-gray-700 leading-snug group-hover:text-gray-400 transition-colors duration-300">
                  {item.question}
                </span>
                ...
                >
                  <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
                    <line x1="7" y1="0" x2="7" y2="14" stroke="#9ca3af" strokeWidth="1.5"/>
                    <line x1="0" y1="7" x2="14" y2="7" stroke="#9ca3af" strokeWidth="1.5"/>
                  </svg>
                </motion.span>
              </button>
              ...
              <AnimatePresence initial={false}>
                {activeIndex === index && (
                  <motion.div
                    ...
                    className="overflow-hidden"
                  >
                    <p className="text-sm text-gray-500 leading-relaxed pb-6 max-w-2xl">
                      {item.answer}
                    </p>
                  </motion.div>
                )}
